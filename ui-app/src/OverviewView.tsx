  ...
  return (
    <>
      ...
      >
        ...
        <Card title="User Service" description="Manages user accounts and loyalty tier assignments">
          <div style={{ marginTop: spacing.lg }}>
            <p style={{ margin: 0, fontSize: '0.9rem', color: colors.text.secondary }}>
      ...
      <Card title="Quick Navigation" description="Access different parts of the system">
        <div
          style={{
            display: 'flex',
            gap: spacing.md,
        ...
        >
          <Button variant="primary" size="lg" onClick={() => onNavigate?.('checkout')}>
            Go to Checkout
          </Button>
        ...
        <p style={{ marginTop: spacing.lg, fontSize: '0.85rem', color: colors.text.muted }}>
          Use the navigation tabs above to switch between Overview, Checkout Preview, and Admin
          Console.
        </p>
      </Card>

      <Card title="System Status" description="Current service availability">
        <div
          style={{
            display: 'grid',
